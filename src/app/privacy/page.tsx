    ...
    <div className="bg-[var(--color-gray-100)] min-h-[calc(100vh-4rem)] py-16 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-[var(--color-gray-200)] p-8 md:p-12">
        ...
        <div className="prose prose-lg text-[var(--color-gray-600)] max-w-none">
          <p>
            At TruFund, we take your privacy and the security of your data extremely seriously. We are committed to protecting the personal information you share with us to secure your educational bridge loan.
          </p>
          ...
          <div className="bg-[var(--color-gray-50)] p-6 rounded-xl border border-[var(--color-gray-200)] mb-6 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm">
                All data transmitted to and from TruFund is encrypted using industry-standard 256-bit TLS encryption. Your government IDs and transcripts are stored in encrypted vaults and are only accessible by authorized underwriting personnel.
              </p>
            </div>
          </div>
          ...
          <p>
            When you check your rate, TruFund performs a "soft pull" on your credit report. This does <strong>not</strong> impact your credit score. We only perform a hard pull if you accept a loan offer and finalize the application process.
          </p>
